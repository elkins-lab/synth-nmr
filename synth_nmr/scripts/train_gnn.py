...
from synth_nmr.neural_shifts import (
    NeuralShiftPredictor,
    NUCLEUS_ORDER,
    build_graph_data
)
...
def train(epochs=10, batch_size=4, lr=1e-3, data_dir="data", save_path="synth_nmr/models/neural_shifts_v1.pt"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save-path", type=str, default="synth_nmr/models/neural_shifts_v1.pt", help="Checkpoint save path")
