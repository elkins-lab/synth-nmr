...
def write_nef_file(
    filename: str, sequence: str, restraints: List[Dict], system_name: str = "synth-nmr-project"
) -> None:
    """
    ...
    for i, r in enumerate(restraints):
        ...
        row = f"      {idx} {idx} "
        row += f"{r['chain_1']} {r['seq_1']} {r['res_name_1']} {r['atom_name_1']} "
        row += f"{r['chain_2']} {r['seq_2']} {r['res_name_2']} {r['atom_name_2']} "
...
def write_nef_relaxation(
    ...
    def write_list(metric_name: str, nef_name: str, unit: str) -> str:
        ...
        block += "   _nef_nmr_measurement_list.sf_category nef_nmr_measurement_list\n"
