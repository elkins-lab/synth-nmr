...
def test_compare_chemical_shifts():
    ...
    pred = {"A": {1: {"CA": 55.0, "HA": 4.5}, 2: {"CA": 60.0, "HA": 4.0}}}

    # Reference with slight deviations
    ref = {"A": {1: {"CA": 55.5, "HA": 4.6}, 2: {"CA": 59.5, "HA": 3.9}}}
...
def test_integration_workflow_mocked(monkeypatch):
    ...
    def mock_predict(self, structure):
        return {"A": {i: {"CA": 50.0 + i} for i in range(1, 6)}}
    ...
    internal_shifts = {"A": {1: {"CA": 51.5}, 2: {"CA": 52.5}}}
