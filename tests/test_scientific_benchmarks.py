...
def test_ubiquitin_j_couplings(ubiquitin_1d3z):
    ...
    assert 3.5 < avg_helix_j < 5.5, f"Helix J-coupling {avg_helix_j} out of expected range (3.5-5.5 Hz)"
    assert 7.5 < avg_sheet_j < 10.5, f"Sheet J-coupling {avg_sheet_j} out of expected range (7.5-10.5 Hz)"
