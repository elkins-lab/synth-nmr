...
def test_chi1_atom_selection_diversity():
    ...
    atoms.extend([
        struc.Atom(atom_name="N", res_id=1, res_name="VAL", chain_id="A", element="N", coord=[0,0,0]),
        struc.Atom(atom_name="CA", res_id=1, res_name="VAL", chain_id="A", element="C", coord=[1,0,0]),
        struc.Atom(atom_name="CB", res_id=1, res_name="VAL", chain_id="A", element="C", coord=[1,1,0]),
        struc.Atom(atom_name="CG1", res_id=1, res_name="VAL", chain_id="A", element="C", coord=[0,1,1]),
    ])
    
    # 2. SER - uses OG
    atoms.extend([
        struc.Atom(atom_name="N", res_id=2, res_name="SER", chain_id="A", element="N", coord=[0,0,0]),
        struc.Atom(atom_name="CA", res_id=2, res_name="SER", chain_id="A", element="C", coord=[1,0,0]),
        struc.Atom(atom_name="CB", res_id=2, res_name="SER", chain_id="A", element="C", coord=[1,1,0]),
        struc.Atom(atom_name="OG", res_id=2, res_name="SER", chain_id="A", element="O", coord=[0,1,1]),
    ])
    
    # 3. CYS - uses SG
    atoms.extend([
        struc.Atom(atom_name="N", res_id=3, res_name="CYS", chain_id="A", element="N", coord=[0,0,0]),
        struc.Atom(atom_name="CA", res_id=3, res_name="CYS", chain_id="A", element="C", coord=[1,0,0]),
        struc.Atom(atom_name="CB", res_id=3, res_name="CYS", chain_id="A", element="C", coord=[1,1,0]),
        struc.Atom(atom_name="SG", res_id=3, res_name="CYS", chain_id="A", element="S", coord=[0,1,1]),
    ])
