...
def structure_no_n_atoms():
    ...
    atom1 = struc.Atom(coord=[0,0,0], atom_name="CA", element="C", res_id=1, res_name="GLY", chain_id="A")
    atom2 = struc.Atom(coord=[0,0,1], atom_name="H", element="H", res_id=1, res_name="GLY", chain_id="A")
    return struc.array([atom1, atom2])

@pytest.fixture
def structure_no_h_atoms():
    """Fixture for a structure missing 'H' atoms."""
    atom1 = struc.Atom(coord=[0,0,0], atom_name="N", element="N", res_id=1, res_name="GLY", chain_id="A")
    atom2 = struc.Atom(coord=[0,0,1], atom_name="CA", element="C", res_id=1, res_name="GLY", chain_id="A")
    return struc.array([atom1, atom2])
